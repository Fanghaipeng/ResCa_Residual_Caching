def cache_init(timesteps, model_kwargs:dict | None):   
    ...
    if mode == 'original':
    ...
    elif mode == 'ClusCa' or mode == 'ResCa':
        cache_dic['cache_type'] = 'random'
        cache_dic['cache_index'] = cache_index
        cache_dic['cache'] = cache
        cache_dic['fresh_ratio_schedule'] = 'ToCa' 
        ...
        cluster_info_dict['proxy_indices'] = None
        cluster_info_dict['temporal_similarity'] = None
        cluster_info_dict['cluster_num'] = cache_dic['cluster_num']
        cluster_info_dict['k'] = cache_dic['k']
