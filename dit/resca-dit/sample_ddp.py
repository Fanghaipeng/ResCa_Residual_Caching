...
def main(args):
    ...
    folder_name = f"{args.mode}-{model_string_name}-{ckpt_string_name}-size-{args.image_size}-vae-{args.vae}-" \
                  ...
                  f"-{args.resca_solver}-{args.resca_proxy_method}"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sample-dir", type=str, default="outputs/dit_samples")
    ...
    # ClusCa/ResCa arguments
    parser.add_argument("--cluster-num", type=int, default=16, help="Number of clusters to use. If 0, fall back to Taylor.")
